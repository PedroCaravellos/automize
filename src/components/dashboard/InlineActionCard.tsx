...
import { Phone, Calendar, CheckCircle2, MessageSquare, ChevronDown, ChevronUp, Edit2, Copy } from "lucide-react";
  ...
  const handleWhatsApp = () => {
    if (lead.telefone) {
      ...
      toast({
        ...
        description: "Converse com seu lead agora.",
      });
    }
  };
